const NATIVE_HOST_NAME = import.meta.env.WXT_NATIVE_HOST_NAME ?? "com.vaultmesh.browser";
...
export class PersistentNativeConnection {
  ...
  constructor(
    private readonly connect: () => NativePort = () => browser.runtime.connectNative(NATIVE_HOST_NAME),
