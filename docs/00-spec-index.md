...
- Browser RPC：`2`
- Native ABI：`1`
- 状态：Tauri 2、Chromium MV3 与 Firefox MV2 扩展为当前实现；Firefox 不包含 Chromium-only Passkey proxy；Electron/Native Preview 源码已移除；`0.0.1-review` 为独立 Review 安装基线，当前 Review 更新版本为 `0.0.7-review`，正式发布门禁未完成
- 最后更新：`2026-08-10`
