...
test("creates stable Chrome and Firefox Review asset names", () => {
  assert.deepEqual(extensionReleaseAssetNames("0.0.4-review"), {
    chrome: "VaultMesh_0.0.4-review_chrome-extension.zip",
    firefox: "VaultMesh_0.0.4-review_firefox-extension.zip",
  });
...
test("accepts browser-specific manifests and rejects identity or permission drift", () => {
  const productVersion = "0.0.4-review";
  const common = { version: "0.0.4", permissions: ["nativeMessaging", "storage"] };
  validateExtensionManifest({
    ...common,
    manifest_version: 3,
